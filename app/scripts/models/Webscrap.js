...
angular.module('sapoApp')
    .factory('Webscrap', ['$http', '$resource', 'REST_API', function($http, $resource, REST_API) {
        ...
        return $resource(API_REST_URL + ':resource/:module/:id/:op/:userid/:prodid/:cant', { }, {
            ...
            searchCategoria         : { method: 'post', params: { resource: 'mercadolibre', module: 'search'},        isArray: true},
